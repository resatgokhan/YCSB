...
This repository uses YCSB-C `CoreWorkload` specs in `workloads/*.spec`. Below is a quick guide to what each property means, how operations are executed, and what the provided workloads do.
